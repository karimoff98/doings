...
42 теста: разбор умных списков во всех вариантах, правила повтора, пакетные операции стора, отмена, импорт базы, порядок при перетаскивании. CI на GitHub Actions прогоняет проверки на каждый пуш, установщики собирает на теге `v*`.
