...
218 тестов: разбор умных списков во всех вариантах, правила повтора, пакетные операции стора, отмена и коалесинг правок текста, надёжность хранилища (сломанный JSON, конфликт ревизий, миграция), сохранение перед выходом (недопечатанный текст, ошибка записи, конфликт базы), определение первого запуска, экраны знакомства и блокировка команд под ними, пустая база против демонстрационных данных, подписи горячих клавиш для macOS и Windows, резервные копии (создание, лимиты хранения, безопасность имён, повреждённые файлы, восстановление), корзина и повторная гидратация, импорт базы, порядок при перетаскивании. CI на GitHub Actions прогоняет проверки на каждый пуш, установщики собирает на теге `v*`.
