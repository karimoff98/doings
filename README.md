...
**Первый запуск.** Три коротких экрана объясняют устройство списков и основные клавиши. Они появляются только на пустом профиле: после обновления, импорта базы или сброса на демо-данные знакомство не показывается.
