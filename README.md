...
**Умные списки.** Входящие, Сегодня (с отдельной вечерней секцией), Предстоящие, В любое время, Когда-нибудь, Журнал, Корзина. Логика повторяет оригинал в неочевидных местах: задачи отложенного проекта исчезают из «В любое время» и всплывают в «Когда-нибудь», просроченная дата поднимает задачу в «Сегодня», задача с одним лишь будущим сроком сдачи всё равно попадает на таймлайн «Предстоящих».
